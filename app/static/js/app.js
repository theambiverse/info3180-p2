    ...
    template: `
        <div class="d-flex align-items-center home-div">
            <div class="row align-items-center col-md-5 intro">
                <h1 class="font-weight-bold home-CTA">Buy and Sell Cars Online</h1>
                <p class="text-secondary fs-1">United Auto Sales provides the fastest, easiest and most user friendly way to buy or sell cars online. Find a Great Price on the Vehicle You Want</p>
                <div class="flex-area">
                    <button @click="reg" class="btn bg-primary text-white" type="button">Register</button>
                    <button @click="login" class="btn btn-success  text-white" type="button">Login</button>
                </div>
            </div>
            <div class="home-image-container">
                <img class="home-image" src="static/images/new-red.jpg">
            </div>
        </div>
    `,
    data() {
    ...
    template: `
          <header>
              <nav class="navbar navbar-expand-lg navbar-dark fixed-top justify-content-between">
                  <a class="navbar-brand" href="/"><img src="static/images/car.png"/>United Auto Sales</a>
